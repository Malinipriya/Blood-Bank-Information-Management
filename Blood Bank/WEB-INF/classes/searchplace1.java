...
public class searchplace1 extends HttpServlet {
...
public void init()
{
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("search")!=null)
	{
	 ...
	 String s1="update purchaser set place=? where uname=?";
	 PreparedStatement p1=connection.prepareStatement(s1);
	 
	 p1.setString(1,place);
	 ...
	 /*if(i2!=0){
       ...
       out.println("<h5>failed to insert the data</h5>");
		...
		out.println("<!DOCTYPE html>");
         ...
         out.println("</div>");
		// out.println("<font  face='Algerian' color='Red' size='5'><form action='donor.html' method='get'>");
		// out.println("User Name					<input type='text' name='uname' id='username' readOnly='true'><br/><br/>");
