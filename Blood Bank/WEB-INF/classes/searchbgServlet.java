...
public class searchbgServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
	 ...
	 /*if(i2!=0){
       ...
       out.println("<h5>failed to insert the data</h5>");
		...
		out.println("<!DOCTYPE html>");
         ...
         out.println("<title>Search By BG Servlet</title>");
		 out.println("</head>");
		 //out.println("<script>function geturl(){var url=document.URL;var array=url.split('&');var uname=array[0].split('=');document.getElementById('purchaserlogin').value=uname[1];}</script>");
	   ...
	   ResultSet res;
		String s3="select * from donor where bg=?";
	...
	try
	{
	 do
	 {
		...
		String place2=res.getString(10);
		 ...
		 out.println("Blood Bank Area:"+place2);
