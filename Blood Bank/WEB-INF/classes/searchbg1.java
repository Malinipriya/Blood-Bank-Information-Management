...
public class searchbg1 extends HttpServlet {
...
public void init()
{
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("search")!=null)
	{
	 ...
	 String s1="update purchaser set bg=? where uname=?";
	 ...
	 /*if(i2!=0){
       ...
       out.println("<h5>failed to insert the data</h5>");
		...
		out.println("<!DOCTYPE html>");
         ...
         out.println("<title>Search By BG Servlet</title></head>");
	...
	try
	{
	 do
	 {
		...
		String place2=res.getString(10);
		 ...
		 out.println("Blood Bank Area:"+place2+"<br><hr>");
