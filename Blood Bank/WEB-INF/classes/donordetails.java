   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("donor")!=null)
	{
		...
		out.println("</div>");
		 ...
		 out.println("<h2>DONOR DETAILS</h3><br>");
		 
	PreparedStatement ps;
			ResultSet rs;
			int count=0;
			String uname,name,age,bg,mobile,weight,email,place,hcount,ddate,dtime;
		...
		ps=connection.prepareStatement(sql);
			...
			out.println("<td>WEIGHT");
			out.println("<td>EMAIL");
			out.println("<td>PLACE");
			out.println("<td>HAEMOGLOBIN<br>COUNT");
			out.println("<td>DONATION<br>DATE");
			out.println("<td>NO. OF TIMES<br>DONATED");
		...
		while(rs.next())
		{
			...
			hcount=rs.getString(11);
			ddate=rs.getString(12);
			dtime=rs.getString(13);
		 ...
		 out.println("<td>" +email);
		 out.println("<td>" +place);
		 out.println("<td>" +hcount);
		 out.println("<td>" +ddate);
		 out.println("<td>" +dtime);
		 out.println("</tr></pre>");
